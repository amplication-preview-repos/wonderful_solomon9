...
const CREATE_INPUT = {
  createdAt: new Date(),
  destinationAddress: "exampleDestinationAddress",
  id: "exampleId",
  receiver: "exampleReceiver",
  requestedOn: new Date(),
  sender: "exampleSender",
  sourceAddress: "exampleSourceAddress",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  createdAt: new Date(),
  ...
  test("POST /deliveryRequests", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        requestedOn: CREATE_RESULT.requestedOn.toISOString(),
      ...
      .expect([
        {
          ...
          requestedOn: FIND_MANY_RESULT[0].requestedOn.toISOString(),
  ...
  test("GET /deliveryRequests/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        requestedOn: FIND_ONE_RESULT.requestedOn.toISOString(),
