...
export class CompanyResolverBase {
  ...
  @graphql.ResolveField(() => [DeliveryRequest], { name: "deliveryRequests" })
  async findDeliveryRequests(
    @graphql.Parent() parent: Company,
    @graphql.Args() args: DeliveryRequestFindManyArgs
  ): Promise<DeliveryRequest[]> {
    const results = await this.service.findDeliveryRequests(parent.id, args);
  ...
  @graphql.ResolveField(() => [Rider], { name: "riders" })
  async findRiders(
    @graphql.Parent() parent: Company,
    @graphql.Args() args: RiderFindManyArgs
  ): Promise<Rider[]> {
    const results = await this.service.findRiders(parent.id, args);
